...
# FUNCION PARA MOSTRAR CANTIDAD DE CLIENTES QUE PASARON POR X CAJA
...
#FUNCION PARA REALIZAR CONTEO DE TODOS LOS CLIENTES QUE PASARON POR CADA CAJA CON SU IMPORTE ACUMULADO
